...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Hemos recibido tu solicitud de reserva para el <strong>{fecha_reserva}</strong> a las
                <strong>{hora_reserva}</strong>. A continuación, te proporcionamos los detalles de tu reserva:
            </p>
            <ul>
                <li><strong>Fecha:</strong> {fecha_reserva}</li>
                <li><strong>Hora:</strong> {hora_reserva}</li>
                <li><strong>Servicio:</strong> {servicio_reservado}</li>
